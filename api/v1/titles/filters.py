...
class TitleFilterSet(filters.FilterSet):
    ...
    imdb_score_min = filters.NumberFilter(field_name="imdb_score", lookup_expr="gte")
    imdb_score_max = filters.NumberFilter(field_name="imdb_score", lookup_expr="lte")
    title_contains = filters.CharFilter(field_name="title", lookup_expr="icontains")
    director = filters.CharFilter(field_name="directors", lookup_expr="name__iexact")
    director_contains = filters.CharFilter(
        field_name="directors", lookup_expr="name__icontains"
    )
    writer = filters.CharFilter(field_name="writers", lookup_expr="name__iexact")
    ...
    country = filters.CharFilter(field_name="countries", lookup_expr="name__iexact")
    country_contains = filters.CharFilter(
        field_name="countries", lookup_expr="name__icontains"
    )
    lang = filters.CharFilter(field_name="languages", lookup_expr="name__iexact")
    lang_contains = filters.CharFilter(
        field_name="languages", lookup_expr="name__icontains"
    )
    company = filters.CharFilter(field_name="company", lookup_expr="name__iexact")
