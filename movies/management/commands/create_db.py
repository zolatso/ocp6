...
class Command(BaseCommand):
    ...
    def create_db_from_csv(self):
        ...
        self.stdout.write(self.style.MIGRATE_HEADING("Executing the migrations..."))
        call_command("migrate")

        self.stdout.write(self.style.MIGRATE_HEADING("Inserting the movies..."))
    ...
    def create_db_default(self, dbname):
        ...
        self.stdout.write(self.style.MIGRATE_HEADING("Installation of the database"))
        self.stdout.write("Populating database with movies info...", ending=" ")
