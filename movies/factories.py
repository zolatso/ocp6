...
class MovieFactory(factory.django.DjangoModelFactory):
    ...
    title = factory.LazyAttribute(lambda obj: fake.text(max_nb_chars=20).strip("."))
    ...
    avg_vote = factory.LazyAttribute(lambda obj: obj.imdb_score - Decimal("0.1"))
    imdb_score = factory.Faker("pydecimal", min_value=1, max_value=10, right_digits=1)
    metascore = factory.Faker("pydecimal", min_value=1, max_value=100, right_digits=1)
    ...
    worldwide_gross_income = factory.Faker("random_int", min=10000, max=10000000)
