...
class Movie(models.Model):
    ...
    avg_vote = models.DecimalField("average user vote", max_digits=3, decimal_places=1)
    imdb_score = models.DecimalField("movie imdb score", max_digits=3, decimal_places=1)
    ...
    budget_currency = models.CharField("movie budget currency", max_length=5, null=True)
    ...
    reviews_from_users = models.IntegerField("number of reviews from users", null=True)
    ...
    def add_directors(self, *directors):
        ...
        for position, director in enumerate(directors, start=n_directors + 1):
            self.directors.add(director, through_defaults={"position": position})
...
class Contributor(models.Model):
    ...
    name = models.CharField("contributor full name", max_length=200, unique=True)
...
class Company(models.Model):
    ...
    name = models.CharField("production company name", max_length=200, unique=True)
